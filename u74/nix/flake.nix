{
  ...
  inputs = {
    nixpkgs.url = "github:nixos/nixpkgs/293d01ba488ddb4c3560ba7c8de1fbec7047f78c";
  ...
  outputs = { self, nixpkgs, flake-utils }:
    let
      ...
      chapel-overlay = final: prev: {
        ...
        chapel_hifive_unmatched_llvm_21 = final.callPackage ./chapel.nix {
          settings = hifive_settings;
          llvmPackages = final.pkgsCross.riscv64.llvmPackages_21;
          pkgsBuildHost = final.pkgsBuildHost // { llvmPackages = final.pkgsBuildHost.llvmPackages_21; };
        };
        chapel_hifive_unmatched_llvm_22 = final.callPackage ./chapel.nix {
          settings = hifive_settings;
          llvmPackages = final.pkgsCross.riscv64.llvmPackages_22;
          pkgsBuildHost = final.pkgsBuildHost // { llvmPackages = final.pkgsBuildHost.llvmPackages_22; };
        };
    ...
    in
    {
      ...
      legacyPackages = flake-utils.lib.eachDefaultSystemMap (system: pkgs-for system);
